...
async def welco857me(client, message):
    ...
    try:
        user = await client.get_chat(OWNER_ID)
          𝒎𝒐𝒅 ❤️ = user.username 
        if message.new_chat_members[0].username == f"{  𝒎𝒐𝒅 ❤️}":
            try:
                ...
                await client.send_message(message.chat.id, 
                    f"**انضم مطور البوت الى هنا الآن [مطور البوت](https://t.me/{  𝒎𝒐𝒅 ❤️})⚡** يرجى من الأعضاء احترام وجوده 🥷🥷"
                )
            except Exception as e:
                await client.send_message(message.chat.id, f"**انضم مطور البوت الى هنا الآن [مطور البوت](https://t.me/{  𝒎𝒐𝒅 ❤️})⚡** يرجى من الأعضاء احترام وجوده 🥷🥷")
    except Exception as e:
        print(e)
...
async def kashf(client, message):
    ...
    if message.reply_to_message:
       ...
       name = user.user.first_name
         𝒎𝒐𝒅 ❤️ = await client.get_chat(user_id)
       bioo =   𝒎𝒐𝒅 ❤️.bio
    elif message.text:
       username = message.text.split(" ", 1)[1]
       user = await client.get_chat_member(message.chat.id, username)
       name = user.user.first_name
         𝒎𝒐𝒅 ❤️ = await client.get_chat(username)
       bioo =   𝒎𝒐𝒅 ❤️.bio
    else:
